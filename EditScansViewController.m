...
@interface EditScansViewController ()
@end

@implementation EditScansViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.passNumber.text =  [_scans objectAtIndex:indexPath.row][0];
    cell.name.text =  [_scans objectAtIndex:indexPath.row][1];
